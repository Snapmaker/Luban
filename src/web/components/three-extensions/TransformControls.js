...
THREE.TransformControls = function ( camera, domElement ) {
    ...
    var objectSizeStart = new THREE.Vector3();
        ...
        if ( mode === 'translate' ) {
            ...
            if ( axis.search( 'XYZ' ) !== -1 ) {
                ...
                if (scope.uniformScale) {
                    ...
                    if ( axis === "X" ) scaleFactor = (pointEnd.x / pointStart.x );
                    if ( axis === "Y" ) scaleFactor = (pointEnd.y / pointStart.y );
                    if ( axis === "Z" ) scaleFactor = (pointEnd.z / pointStart.z );
                    // set limit: the object size must be larger than (10, 10, 10);
