...
class CoordinateAxes {
    ...
    constructor(minX, maxX, minY, maxY) {
        ...
        this.group.add(
            buildAxis(new THREE.Vector3(0, 0, 0), new THREE.Vector3(maxX, 0, 0), red, false), // +X
            buildAxis(new THREE.Vector3(0, 0, 0), new THREE.Vector3(minX, 0, 0), red, true), // -X
            buildAxis(new THREE.Vector3(0, 0, 0), new THREE.Vector3(0, maxY, 0), green, false), // +Y
            buildAxis(new THREE.Vector3(0, 0, 0), new THREE.Vector3(0, minY, 0), green, true), // -Y
        );
