...
class Settings extends PureComponent {
    ...
    render() {
        ...
        videoDeviceOptions.unshift({
            value: '',
            label: i18n._('key-unused-Auto Detection')
        });
        ...
        return (
            ...
            >
                <Modal.Header>
                    {/* <Modal.Title> */}
                    {i18n._('key-unused-Webcam Settings')}
                    {/* </Modal.Title> */}
                </Modal.Header>
                <Modal.Body>
                    <div className="form-group">
                        <strong>{i18n._('key-unused-Media Source')}</strong>
                        <div className="radio" style={{ marginTop: 0 }}>
                            <span>
                                ...
                                />
                                {i18n._('key-unused-Use a built-in camera or a webcam')}
                            </span>
                        </div>
                        ...
                        <div className="radio">
                            <span>
                                ...
                                />
                                {i18n._('key-unused-Use a M-JPEG stream over HTTP')}
                            </span>
                        </div>
                        <div style={{ marginLeft: 20 }}>
                            <input
                ...
                <Modal.Footer>
                    ...
                    >
                        {i18n._('key-unused-Save Changes')}
                    </button>
                </Modal.Footer>
            </Modal>
        );
