    ...
    render() {
        ...
        return (
            <Modal style={{ width: '480px', height: '720px' }} size="lg" onClose={this.props.hideModal}>
                ...
                <Modal.Header>
                    {i18n._('key-Laser/CamaeraCaptureOriginal-Engrave Square')}
                </Modal.Header>
                ...
                <Modal.Body>
                    ...
                    <div className="margin-top-16 margin-left-16">
                        <table className={styles['parameter-table']}>
                            <tbody>
                                <tr>
                                    <td>
                                        {i18n._('key-Laser/CamaeraCaptureOriginal-Side Length')}
                                    </td>
                                    <td>
                                        <Slider
                                ...
                                <tr>
                                    <td>
                                        {i18n._('key-Laser/CamaeraCaptureOriginal-Power')}
                                    </td>
                                    <td>
                                        <Slider
                                            className="margin-right-8 float-r"
                    ...
                    >
                        {i18n._('key-Laser/CamaeraCaptureOriginal-Print Square Trace')}
                    </Button>
                </Modal.Body>
                <Modal.Footer>
                    <Button
                    ...
                    >
                        {i18n._('key-Laser/CamaeraCaptureOriginal-Next')}
                    </Button>
                </Modal.Footer>
            </Modal>
        );
...
const mapDispatchToProps = (dispatch) => ({
    renderGcode: (name, gcode) => dispatch(workspaceActions.renderGcodeFile(gcode, false)),
