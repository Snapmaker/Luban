...
class CoordinateAxes {
    ...
    constructor(offsetX, width, height) {
        ...
        this.group.add(
            ...
            buildAxis(new THREE.Vector3(offsetX, 0, 0), new THREE.Vector3(offsetX + width, 0, 0), red, false), // +X
            buildAxis(new THREE.Vector3(offsetX, 0, 0), new THREE.Vector3(offsetX, height, 0), green, false) // +Y
        );
