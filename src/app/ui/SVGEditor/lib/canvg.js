...
})(canvgv2, function (rgbcolor, stackblurCanvas) {
    "use strict";

    rgbcolor =
        rgbcolor && rgbcolor.hasOwnProperty("default")
            ? rgbcolor["default"]
            : rgbcolor;
    stackblurCanvas =
    ...
    var canvg_1 = createCommonjsModule(function (module) {
        ...
        var canvg = function (target, s, opts) {
            ...
            if (target == null && s == null && opts == null) {
                ...
                for (var i = 0; i < svgTags.length; i++) {
                    ...
                    if (
                        typeof svgTag.clientWidth !== "undefined" &&
                        typeof svgTag.clientHeight !== "undefined"
                    ) {
        ...
        var matchesSelector;
        {
            ...
            if (typeof Element == "undefined");
                ...
                if (
                    typeof matchesSelector === "undefined" &&
        ...
        function build(opts) {
            ...
            svg.parseXml = function (xml) {
                if (
                    ...
                    try {
                        var parser = opts.xmldom
                            ? new windowEnv.DOMParser(opts.xmldom)
                            : new windowEnv.DOMParser();
            ...
            svg.Property.prototype.getFillStyleDefinition = function (
                ...
                if (def != null && def.createPattern) {
                    if (def.getHrefAttribute().hasValue()) {
                        ...
                        if (pt.hasValue()) {
                            def.attribute("patternTransform", true).value =
                                pt.value;
                        }
                    }
            ...
            svg.Property.prototype.toPixels = function (
                ...
                var s = this.value + "";
                if (s.match(/rem$/))
                    return this.numValue() * this.getREM(viewPort);
                if (s.match(/em$/))
                ...
                if (s.match(/pt$/))
                    return (
                        this.numValue() * this.getDPI(viewPort) * (1.0 / 72.0)
                    );
            ...
            svg.Element.ElementBase = function (node) {
                        ...
                        if (
                            ...
                            if (styles != null) {
                                for (var name in styles) {
                                    var existingSpecificity =
                                        this.stylesSpecificity[name];
                                    if (
                                        typeof existingSpecificity ==
                                        "undefined"
                                    ) {
                ...
                if (node != null && node.nodeType == 1) {
                    ...
                    for (var i = 0; i < node.attributes.length; i++) {
                        ...
                        var nodeName = normalizeAttributeName(
                            attribute.nodeName
                        );
                ...
                this.setContext = function (ctx, fromMeasure) {
                    if (!fromMeasure) {
                        ...
                        if (this.style("stroke-width").hasValue()) {
                            ...
                            ctx.lineWidth =
                                newLineWidth == 0 ? 0.001 : newLineWidth; // browsers don't respect 0
                        }
                        ...
                        if (this.style("paint-order").hasValue())
                            ctx.paintOrder = this.style("paint-order").value;
                        if (
                            ...
                            var offset =
                                this.style("stroke-dashoffset").toPixels();
                            if (typeof ctx.lineDashOffset != "undefined") {
                                ctx.lineDashOffset = offset;
                            } else if (
                                typeof ctx.webkitLineDashOffset != "undefined"
                            ) {
                    ...
                    if (typeof ctx.font != "undefined") {
                        if (this.style("font").hasValue()) {
                            ...
                            var currentFontSize = this.style(
                                "font-size",
                                false,
                                false
                            );
                ...
                this.renderChildren = function (ctx) {
                    ...
                    if (markers != null) {
                        ...
                        if (this.style("marker-mid").isUrlDefinition()) {
                            var marker =
                                this.style("marker-mid").getDefinition();
                        ...
                        if (this.style("marker-end").isUrlDefinition()) {
                            var marker =
                                this.style("marker-end").getDefinition();
                            marker.render(
                                ctx,
            ...
            svg.Element.svg = function (node) {
                ...
                this.setContext = function (ctx) {
                    ...
                    if (
                        ...
                        typeof windowEnv.getComputedStyle != "undefined"
                    ) {
                        ctx.font = windowEnv
                        ...
                        var fontSize = new svg.Property(
                            "fontSize",
                            svg.Font.Parse(ctx.font).fontSize
                        );
                        if (fontSize.hasValue())
                            svg.rootEmSize = svg.emSize =
                                fontSize.toPixels("y");
                    }
                    ...
                    if (typeof this.root == "undefined") {
                        ...
                        if (
                            this.attribute("overflow").valueOrDefault(
                                "hidden"
                            ) != "visible"
                        ) {
                            ctx.beginPath();
                    ...
                    this.addMarker = function (p, from, priorTo) {
                        ...
                        if (
                            ...
                            this.angles[this.angles.length - 1] =
                                this.points[this.points.length - 1].angleTo(
                                    priorTo
                                );
                        }
                        this.addMarkerAngle(
                ...
                this.inheritStopContainer = function (stopsContainer) {
                    for (var i = 0; i < this.attributesToInherit.length; i++) {
                        ...
                        if (
                            ...
                            stopsContainer
                                .attribute(attributeToInherit)
                                .hasValue()
                        ) {
                            this.attribute(attributeToInherit, true).value =
                                stopsContainer.attribute(
                                    attributeToInherit
                                ).value;
                        }
                    }
            ...
            svg.Element.linearGradient = function (node) {
                ...
                this.getGradient = function (ctx, element) {
                    ...
                    var x1 =
                        this.gradientUnits() == "objectBoundingBox"
                            ? bb.x() +
                              bb.width() * this.attribute("x1").numValue()
                            : this.attribute("x1").toPixels("x");
                    var y1 =
                        this.gradientUnits() == "objectBoundingBox"
                            ? bb.y() +
                              bb.height() * this.attribute("y1").numValue()
                            : this.attribute("y1").toPixels("y");
                    var x2 =
                        this.gradientUnits() == "objectBoundingBox"
                            ? bb.x() +
                              bb.width() * this.attribute("x2").numValue()
                            : this.attribute("x2").toPixels("x");
                    var y2 =
                        this.gradientUnits() == "objectBoundingBox"
                            ? bb.y() +
                              bb.height() * this.attribute("y2").numValue()
                            : this.attribute("y2").toPixels("y");
            ...
            svg.Element.radialGradient = function (node) {
                ...
                this.getGradient = function (ctx, element) {
                    ...
                    var cx =
                        this.gradientUnits() == "objectBoundingBox"
                            ? bb.x() +
                              bb.width() * this.attribute("cx").numValue()
                            : this.attribute("cx").toPixels("x");
                    var cy =
                        this.gradientUnits() == "objectBoundingBox"
                            ? bb.y() +
                              bb.height() * this.attribute("cy").numValue()
                    ...
                    if (this.attribute("fx").hasValue()) {
                        fx =
                            this.gradientUnits() == "objectBoundingBox"
                                ? bb.x() +
                                  bb.width() * this.attribute("fx").numValue()
                    ...
                    if (this.attribute("fy").hasValue()) {
                        fy =
                            this.gradientUnits() == "objectBoundingBox"
                                ? bb.y() +
                                  bb.height() * this.attribute("fy").numValue()
                ...
                for (var i = 0; i < this.children.length; i++) {
                    ...
                    if (child.type == "font-face") {
                        ...
                        if (child.style("font-family").hasValue()) {
                            svg.Definitions[child.style("font-family").value] =
                                this;
                        }
                        ...
                        if (child.arabicForm != "") {
                            ...
                            this.isArabic = true;
                            if (
                                typeof this.glyphs[child.unicode] == "undefined"
                            )
                                this.glyphs[child.unicode] = [];
                            this.glyphs[child.unicode][child.arabicForm] =
                                child;
                        } else {
            ...
            svg.Element.text = function (node) {
                ...
                this.setContext = function (ctx) {
                    ...
                    var textBaseline =
                        this.style("dominant-baseline").toTextBaseline();
                    if (textBaseline == null)
                        textBaseline =
                            this.style("alignment-baseline").toTextBaseline();
                ...
                this.getBoundingBox = function (ctx) {
                    ...
                    var bb = null;
                    for (var i = 0; i < this.children.length; i++) {
                        var childBB = this.getChildBoundingBox(
                            ctx,
                            this,
                            this,
                            i
                ...
                this.adjustChildCoordinates = function (
                    ctx,
                    textParent,
                    parent,
                    i
                    ...
                    if (child.attribute("x").hasValue()) {
                        child.x =
                            ...
                            textParent.getAnchorDelta(ctx, parent, i);

                        // local text-anchor
                        var textAnchor = child
                        ...
                        if (textAnchor !== "start") {
                            ...
                            child.x +=
                                -1 *
                                (textAnchor == "end" ? width : width / 2.0);
                        }
                ...
                this.getChildBoundingBox = function (
                    ctx,
                    textParent,
                    parent,
                    i
                ) {
                    var child = this.adjustChildCoordinates(
                        ctx,
                        textParent,
                        parent,
                        i
                    ...
                    for (var i = 0; i < child.children.length; i++) {
                        var childBB = textParent.getChildBoundingBox(
                            ctx,
                            textParent,
                            child,
                            i
                ...
                this.renderChildren = function (ctx) {
                    ...
                    if (customFont != null) {
                        ...
                        for (var i = 0; i < text.length; i++) {
                            ...
                            var scale =
                                fontSize / customFont.fontFace.unitsPerEm;
            ...
            svg.Element.a = function (node) {
                ...
                this.text = this.hasText
                    ? node.childNodes[0].value || node.childNodes[0].data
                    : "";
                this.getText = function () {
                    return this.text;
                };
            ...
            svg.Element.textPath = function (node) {
                ...
                this.renderChildren = function (ctx) {
                    ...
                    ctx.save();
                    var textDecoration =
                        this.parent.style("text-decoration").value;
                    ...
                    for (var i = 0; i < glyphInfo.length; i++) {
                        ...
                        if (ctx.fillStyle != "")
                            ctx.fillText(svg.compressSpaces(partialText), 0, 0);
                        if (ctx.strokeStyle != "")
                            ctx.strokeText(
                                svg.compressSpaces(partialText),
                                0,
                                0
                            );
                        ctx.restore();
                ...
                this.setTextData = function (ctx) {
                    ...
                    for (var i = 0; i < this.getText().length; i++) {
                        this.letterSpacingCache.push(
                            dx[i] !== undefined ? dx[i] : letterSpacing
                        );
                    }

                    var dxSum = this.letterSpacingCache.reduce(function (
                        acc,
                        cur
                    ) {
                        return acc + cur || 0;
                    ...
                    var startOffset =
                        this.style("startOffset").numValueOrDefault(0) *
                        fullPathWidth;
                    var offset = 0;
                    ...
                    var findSegmentToFitChar = function (c, charI) {
                        ...
                        if (
                            ...
                            glyphWidth +=
                                (fullPathWidth - textFullWidth) / spacesNumber;
                        }
                        ...
                        var segment = {
                            p0: that.getEquidistantPointOnPath(
                                offset,
                                splineStep
                            ),
                            p1: that.getEquidistantPointOnPath(
                                offset + glyphWidth,
                                splineStep
                            ),
                        };
                    ...
                    for (var i = 0; i < charArr.length; i++) {
                        ...
                        if (
                            segment.p0 === undefined ||
                            segment.p1 === undefined
                        ) {
                            continue;
                        }

                        var width = that.getLineLength(
                            segment.p0.x,
                            segment.p0.y,
                            segment.p1.x,
                            segment.p1.y
                        ...
                        var midpoint = that.getPointOnLine(
                            kern + width / 2.0,
                            segment.p0.x,
                            segment.p0.y,
                            segment.p1.x,
                    ...
                    for (var i = 0; i < this.dataArray.length; i++) {
                        ...
                        switch (pathCmd.command) {
                            ...
                            case "A":
                                ...
                                currentT =
                                    start +
                                    (delta / pathCmd.pathLength) * dTheta;
                                if (
                ...
                this.getEquidistantPointOnPath = function (
                    targetDistance,
                    step,
                    precision
                ) {
                ...
                this.getPointOnLine = function (
                    ...
                    if (P2x === P1x) {
                        ...
                        (fromY - P1y) / (fromX - P1x + 0.00000001) ===
                        m
                    ) {
                        pt = {
                            x: fromX + run,
                ...
                this.getPointOnQuadraticBezier = function (
                    pct,
                    P1x,
                    P1y,
                    P2x,
                ...
                this.getPointOnEllipticalArc = function (
                    cx,
                    cy,
                    rx,
                    ry,
                            ...
                            if (cssClass != "") {
                                ...
                                if (cssClass == "@font-face" && !nodeEnv) {
                                    ...
                                    for (var s = 0; s < srcs.length; s++) {
                                        if (
                                            srcs[s].indexOf('format("svg")') > 0
                                        ) {
                                            var url = svg.ParseExternalUrl(
                                                srcs[s]
                                            );
                                            if (url) {
            ...
            svg.Element.use = function (node) {
                ...
                this.elementTransform = function () {
                    if (
                        element != null &&
                        element.style("transform", false, true).hasValue()
                    ) {
                        return new svg.Transform(
                            element.style("transform", false, true).value
                        );
                    }
                };
                ...
                this.renderChildren = function (ctx) {
                    if (element != null) {
                        ...
                        if (element.type == "symbol") {
                            ...
                            tempSvg.attributes["preserveAspectRatio"] =
                                new svg.Property(
                                    "preserveAspectRatio",
                                    element.attribute(
                                        "preserveAspectRatio"
            ...
            svg.Element.mask = function (node) {
                ...
                this.apply = function (ctx, element) {
                    ...
                    if (width == 0 && height == 0) {
                        ...
                        for (var i = 0; i < this.children.length; i++) {
                            bb.addBoundingBox(
                                this.children[i].getBoundingBox(ctx)
                            );
                        }
                    ...
                    for (var i = 0; i < this.children.length; i++) {
                        ...
                        if (typeof child.path != "undefined") {
                            var transform =
                                ...
                                child.elementTransform(); // handle <use />
                            if (
                                !transform &&
                                child.style("transform", false, true).hasValue()
                            ) {
                    ...
                    svg.intervalID = setInterval(function () {
                        ...
                        if (svg.opts["ignoreAnimation"] != true) {
                            for (var i = 0; i < svg.Animations.length; i++) {
                                var needAnimationUpdate = svg.Animations[
                                    i
                                ].update(1000 / svg.FRAMERATE);
...
export default canvgv2.canvgv2;
