...
const SMDropdownButton = React.memo(({ state, actions }) => {
    ...
    return (
        <Widget.DropdownButton
            title={i18n._('key_ui/layouts/Widget/SMDropdownButton_fullscreen')}
        ...
        >
            <Widget.DropdownMenuItem eventKey="fullscreen">
                ...
                {!fullscreen ? i18n._('key_ui/layouts/Widget/SMDropdownButton_Enter Full Screen') : i18n._('key_ui/layouts/Widget/SMDropdownButton_Exit Full Screen')}
