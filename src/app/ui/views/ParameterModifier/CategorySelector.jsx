...
import { LEFT_EXTRUDER, RIGHT_EXTRUDER, WHITE_COLOR } from '../../../constants';
...
const CategorySelector = ({
    ...
    return (
        <>
            {mode === 'show' && (
                <div
                    className="width-264 background-color-white height-percent-100"
                    style={{
                        minWidth: '264px'
                    }}
                >
                                    ...
                                    isDualExtruder(printingToolhead) ? (
                                        <div>
                                            ...
                                            >
                                                ...
                                                <div className="margin-left-4 height-24 width-all-minus-36 text-overflow-ellipsis">L: {i18n._(leftExtruderMaterial.i18nName || leftExtruderMaterial.name)}</div>
                                            </Anchor>
                                            <Anchor
                                            ...
                                            >
                                                ...
                                                <div className="margin-left-4 height-24 width-all-minus-36 text-overflow-ellipsis">R: {i18n._(rightExtruderMaterial.i18nName || rightExtruderMaterial.name)}</div>
                                            </Anchor>
                                        </div>
                                    ) : (
