...
import { DUAL_EXTRUDER_TOOLHEAD_FOR_SM2, HEAD_PRINTING, LEFT_EXTRUDER, RIGHT_EXTRUDER } from '../../../constants';
import { getPresetOptions } from '../../utils/profileManager';
import { actions as projectActions } from '../../../flux/project';

const ProfileGroupManager = ({
    outsideActions
}) => {
    const needShowTipModal = machineStore.get('settings.needShowProfileGroupTip');
    const {
        defaultDefinitions, qualityDefinitions, defaultMaterialId,
        defaultMaterialIdRight, qualityDefinitionsRight, definitionEditorForExtruder,
    ...
    return (
        <React.Fragment>
            <Modal
                ...
                style={{ minWidth: 700 }}
                onClose={outsideActions.closeGroupManager}
            >
                <Modal.Header>
                    <div>
                        {i18n._('key-3DP/MainToolBar-Profile editor')}
                        <SvgIcon
                            name="Information"
...
ProfileGroupManager.propTypes = {
    outsideActions: PropTypes.object.isRequired,
};

export default ProfileGroupManager;
