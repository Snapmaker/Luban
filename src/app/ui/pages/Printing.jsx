...
function useRenderMainToolBar() {
    ...
    const canRedo = useSelector(state => state?.operationHistory.history?.canRedo, shallowEqual);
    const canUndo = useSelector(state => state?.operationHistory.history?.canUndo, shallowEqual);
