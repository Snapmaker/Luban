...
const MachineSettings = forwardRef(({
    ...
    const { extruderLDefinition, extruderRDefinition } = useSelector(state => state?.printing);
    ...
    const availableToolOptions = getMachineSupportedToolOptions(selectedMachineSeries, headType);
