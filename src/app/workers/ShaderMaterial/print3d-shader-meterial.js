...
export const PRINT3D_FRAG_SHADER = [
    ...
    'uniform vec3 color;',
    'uniform int type_code;',
    'uniform int tool_code;',
    'uniform int layer;',

    'void main(){',
    '    if(layer > u_visible_layer_range_end){',
    // '        gl_FragColor = vec4(0.87, 0.87, 0.87, 0.75);',
    '        discard;',
    '    }',

    '    if(u_visible_layer_range_start > layer){',
    // '        gl_FragColor = vec4(0.87, 0.87, 0.87, 0.75);',
    '        discard;',
    '    }',

    '    if(u_l_wall_inner_visible == 0 && type_code == 1 && tool_code == 0){',
    '        discard;',
    '    }',

    '    if(u_l_wall_outer_visible == 0 && type_code == 2 && tool_code == 0){',
    '        discard;',
    '    }',

    '    if(u_l_skin_visible == 0 && type_code == 3 && tool_code == 0){',
    '        discard;',
    '    }',

    '    if(u_l_skirt_visible == 0 && type_code == 4 && tool_code == 0){',
    '        discard;',
    '    }',

    '    if(u_l_support_visible == 0 && type_code == 5 && tool_code == 0){',
    '        discard;',
    '    }',

    '    if(u_l_fill_visible == 0 && type_code == 6 && tool_code == 0){',
    '        discard;',
    '    }',

    '    if(u_l_travel_visible == 0 && type_code == 7 && tool_code == 0){',
    '        discard;',
    '    }',

    '    if(u_l_unknown_visible == 0 && type_code == 8 && tool_code == 0){',
    '        discard;',
    '    }',

    '    if(u_r_wall_inner_visible == 0 && type_code == 1 && tool_code == 1){',
    '        discard;',
    '    }',

    '    if(u_r_wall_outer_visible == 0 && type_code == 2 && tool_code == 1){',
    '        discard;',
    '    }',

    '    if(u_r_skin_visible == 0 && type_code == 3 && tool_code == 1){',
    '        discard;',
    '    }',

    '    if(u_r_skirt_visible == 0 && type_code == 4 && tool_code == 1){',
    '        discard;',
    '    }',

    '    if(u_r_support_visible == 0 && type_code == 5 && tool_code == 1){',
    '        discard;',
    '    }',

    '    if(u_r_fill_visible == 0 && type_code == 6 && tool_code == 1){',
    '        discard;',
    '    }',

    '    if(u_r_travel_visible == 0 && type_code == 7 && tool_code == 1){',
    '        discard;',
    '    }',

    '    if(u_r_unknown_visible == 0 && type_code == 8 && tool_code == 1){',
    '        discard;',
    '    }',
    '    if (type_code == 7) {',
    ...
    '        } else {',
    '           u_material_diffuse = vec4(u_color0, 1.0);',
    '           if(u_color_type == 1 && type_code != 7){',
    '               u_material_diffuse = vec4(u_color1, 1.0);',
    '           }',
    '       }',
    // '       return;',
    '    } else {',
    ...
    '   u_material_diffuse = vec4(color, 1.0);',
