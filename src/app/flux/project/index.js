    ...
    openProject: (file, history, unReload = false) => async (dispatch) => {
        if (checkIsSnapmakerProjectFile(file.name)) {
            ...
            await dispatch(actions.save(oldHeadType, {
                message: i18n._('key_flux/project/index_Save the changes you made in the {{headType}} G-code Generator? Your changes will be lost if you don’t save them.', { headType: HEAD_TYPE_ENV_NAME[oldHeadType] })
            }));
