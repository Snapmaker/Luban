...
const processFocusOffset = defaultAPIFactory((options) => request.post('/api/image/processFocusOffset', options));

const processSnapShot = defaultAPIFactory((options) => request.post('/api/image/snapShot', options));
