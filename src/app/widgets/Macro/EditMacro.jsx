                ...
                <Modal.Body>
                    ...
                    >
                        <div className="form-group">
                            <label htmlFor="macroName">{i18n._('Macro Name')}</label>
                            <Input
                                ref={c => {
                                    this.fields.name = c;
                                }}
                        ...
                        <div className="form-group">
                            <div>
                                <label htmlFor="macroCommands">{i18n._('Macro Commands')}</label>
                                <Dropdown
                    ...
                    <Button
                        ...
                        onClick={() => {
                            this.form.validate(err => {
                                ...
                                actions.updateMacro(id, { name: this.value.name, content: this.value.content });
                                actions.closeModal();
                            });
                        }}
                    >
