            ...
            <div>
                ...
                <div style={{ display: this.state.panel === PANEL_EXTRACT_TRACE ? 'block' : 'none' }}>
                    ...
                    <div style={{ margin: '1rem 0' }}>
                        {i18n._(`The camera on the laser module captures images
                            of the work area, and stitch them together as the
                            background. The accuracy of Camera Calibration
                            affects how the captured image is mapped with
                            machine coordinates. If you have reinstalled
                            the laser module, please redo Camera Calibration
