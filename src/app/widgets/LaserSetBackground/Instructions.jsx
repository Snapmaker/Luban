    ...
    return (
        <Modal style={{ width: '1080px' }} size="lg" onClose={onClose}>
            ...
            <Modal.Body>
                ...
                >
                    <p>
                        <Trans i18nKey="(key)Laser setting_background main_description">
                    ...
                    <ol>
                        <li>
                            <Trans i18nKey="(key)Laser setting_background description 1">
                                1. Place a piece of paper or wood sheet on the platform.
                            </Trans>
                        </li>
                        <li>
                            <Trans i18nKey="(key)Laser setting_background description 2">
                                2. Set the work origin again.
                            </Trans>
                        </li>
                        <li>
                            <Trans i18nKey="(key)Laser setting_background description 3">
                                3. Go to <b>Laser G-code Generator</b> &gt; <b>Set Background</b>.
                                Click <b>Add Background</b>.
                            </Trans>
                        </li>
                        <li>
                            <Trans i18nKey="(key)Laser setting_background description 4">
                    ...
                    <div className={styles['laser-set-background-instruction-step-detail']} style={{ marginLeft: '25px' }}>
                        <ol>
                            <li>
                                <Trans i18nKey="(key)Laser setting_background description 4_1">
                            ...
                            <li>
                                <Trans i18nKey="(key)Laser setting_background description 4_2">
                            ...
                            <li>
                                <Trans i18nKey="(key)Laser setting_background description 4_3">
                                    Send the photo to your computer.
                                </Trans>
                            </li>
                            <li>
                                <Trans i18nKey="(key)Laser setting_background description 4_4">
                            ...
                            />
                            <li>
                                <Trans i18nKey="(key)Laser setting_background description 4_5">
                ...
                >
                    <ol>
                        <li>
                            <Trans i18nKey="(key)Laser setting_background description 5">
                        ...
                        />
                        <li>
                            <Trans i18nKey="(key)Laser setting_background description 6">
                                6. Click <b>Generate G-code</b> and then <b>Load G-code to Workspace</b>.
                            </Trans>
                        </li>
                        <li>
                            <Trans i18nKey="(key)Laser setting_background description 7">
                        ...
                        />
                        <p>
                            <Trans i18nKey="(key)Laser setting_background description 7_1">
                        ...
                        <li>
                            <Trans i18nKey="(key)Laser setting_background description 8">
