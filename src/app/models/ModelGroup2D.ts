...
import _, { filter, includes, replace } from 'lodash';
import {
    Box3,
    BufferGeometry,
...
import { EPSILON, HEAD_CNC, HEAD_LASER, SELECTEVENT } from '../constants';
...
class ModelGroup2D extends EventEmitter {
    ...
    // Calculate selectedGroup's BBox in modelGroup2D
