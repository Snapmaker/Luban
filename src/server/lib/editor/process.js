import { processBW, processCNCGreyscale, processLaserGreyscale, processNewsprint, processVector } from './image-process';
import {
    PROCESS_MODE_BW,
    PROCESS_MODE_GREYSCALE,
    PROCESS_MODE_NEWSPRINT,
    PROCESS_MODE_VECTOR,
    SOURCE_TYPE_DXF,
    SOURCE_TYPE_IMAGE3D,
    SOURCE_TYPE_RASTER
...
export const editorProcess = (modelInfo) => {
    ...
    if (sourceType === SOURCE_TYPE_RASTER) {
        ...
        } else if (mode === PROCESS_MODE_NEWSPRINT) {
